...
export OPENRESTY_INSTALL="$BUILD_ROOT/openresty"
ls -la $OPENRESTY_INSTALL
export PATH="$BUILD_ROOT/luarocks/bin:$BUILD_ROOT/openssl/bin:$BUILD_ROOT/openresty/bin:$BUILD_ROOT/openresty/nginx/sbin:PATH"
